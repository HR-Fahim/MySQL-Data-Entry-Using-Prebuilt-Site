...
<?php 
  ...
  $user_email =  $_GET['link'];
  
  // write query for all pizzas
  $sql = "SELECT * FROM `job_seeker` WHERE EMAIL = '$user_email'";
                ...
                <hr>
                  <form class="form" action="update.php" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                           <div class="col-xs-12">
                                <br>
                              	<a href="http://localhost/online%20Job-portal/Confirmation/confirmation.php" class="btn btn-primary btn-lg" role="button" type="reset"><i class="glyphicon glyphicon-repeat"></i> NEXT </a>
                            </div>
                      </div>
                      <?php } ?>
              	</form>
