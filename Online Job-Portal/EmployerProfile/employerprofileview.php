...
<?php 
  ...
  $sql = "SELECT * FROM `job_provider`   ORDER BY `JOB_PROVIDER_ID` DESC LIMIT 1";
                ...
                <hr>
                  <form class="form" action="update.php" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                           <div class="col-xs-12">
                                <br>
                              	<a href="./employerprofile.php" class="btn btn-primary btn-lg" role="button" type="reset"><i class="glyphicon glyphicon-repeat"></i> RESET </a>
                                <a href="http://localhost/online%20Job-portal/EmployeesChoosing/employeechoosing.php" class="btn btn-lg btn-success" type="submit" name="save"><i class="glyphicon glyphicon-ok-sign"></i> Done</a>
                            </div>
                      </div>
                      <?php } ?>
              	</form>
